package com.udfex.framework.mybatis.dao.impl;
...
import com.udfex.framework.mybatis.page.PageFormat;
import com.udfex.framework.mybatis.page.PageInfo;
import com.udfex.framework.mybatis.page.PageInterceptor;
import com.udfex.framework.mybatis.page.PageModel;
import com.udfex.framework.mybatis.utils.ModelUtils;
import com.udfex.framework.support.SpringContextUtil;
import com.udfex.framework.utils.AssertExt;
import com.udfex.framework.utils.DateUtils;

public class MybatisDaoImpl extends SqlSessionDaoSupport implements MybatisDao {

    private static final String SQL_MAPPER_BASE_NAMESPACE = "com.udfex.framework.mybatis.mapper.BaseMybatisMapper.";
    ...
    @Override
    public <MODEL extends BaseMybatisModel> PageModel<MODEL> selectPageByModel(MODEL model) {
    ...
    @Override
    public <MODEL extends BaseMybatisModel, EXAMPLE extends BaseMybatisExample> PageModel<MODEL> selectPageByExample(EXAMPLE example) {
    ...
    @Override
    public PageModel<?> selectPage(String mapperId, Object object, PageInfo pageInfo) {
        AssertExt.isInvalidParameter(null == object,
                "Parameter model is require and can't support null object to be selectPageByModel(), but found: " + object);
        AssertExt.isInvalidParameter(null == pageInfo,
                "Parameter pageInfo is require and can't support null object to be selectPageByModel(), but found parameter pageInfo: " + pageInfo);
        AssertExt.isInvalidParameter(0 >= pageInfo.getPageSize() || 0 >= pageInfo.getPageNum(),
                "Parameter pageInfo of pageSize and pageNum value must greater than 0 to be selectPageByModel()," +
                        " but found parameter pageInfo of pageSize: " + pageInfo.getPageSize() + ", pageNum: " + pageInfo.getPageNum());
        PageInterceptor.startPage(pageInfo.getPageNum(), pageInfo.getPageSize());
